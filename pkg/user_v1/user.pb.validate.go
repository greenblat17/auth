...
func (m *UserInfo) validate(all bool) error {
	...
	if !_UserInfo_Email_Pattern.MatchString(m.GetEmail()) {
		err := UserInfoValidationError{
			field:  "Email",
...
var _UserInfo_Email_Pattern = regexp.MustCompile("^\\S+@\\S+\\.\\S+$")
...
var _CreateRequest_Email_Pattern = regexp.MustCompile("^\\S+@\\S+\\.\\S+$")
